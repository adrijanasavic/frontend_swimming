                ...
                return (
                    <div key={index}>
                        <div class="horizontal posts">
                            ...
                            <section class="back">
                                <h2 style={isOpen ? null : paragrafStyles}>{language === "En" ? item.descriptionEn : item.description}</h2>
                                <div className="btn_detail">
                                    <Link className="custom__button" to={`/postdetail/${item._id}`}>
                            ...
                            {user && (
                                <div className="post__btn">
                                    <Link className="custom__button " to={`/post/${item._id}`}>Izmena</Link>
                                    <Link className="custom__button " onClick={() => deletePost(item._id)}>Brisanje</Link>
                                </div>
                            )}
                        </div>
                        {/* 
