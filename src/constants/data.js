const nav = {
  ...
  Kinesi: { Sr: "Kineziterapija", En: "Kinesitherapy" },
...
const header = {
  title: {
    Sr: "Oslobodite se straha",
    En: "Free yourself from fear",
  },
  description: {
    Sr: "Jedinstveni program obuke za apsolutne početnike i sve one koji žele da nauče pravilno izvođenje prsne, kraul, leđne i delfin tehnike bez obzira na uzrast korisnika.",
...
const about = {
  msc1: {
    Sr: "Diplomirani Msc sporta i fizičkog vaspitanja sa više od 23 godine iskustva u radu sa neplivačima, licencirani učitelj plivanja sa preko 20 000 časova treninga, moja strast i cilj je da pomognem ljudima da savladaju svoj strah od vode i unaprede svoje veštine plivanja.",
    En: "Graduated Msc of Sports and Physical Education with more than 23 years of experience working with non-swimmers, licensed swimming instructor with over 20,000 hours of training, my passion and goal is to help people overcome their fear of water and improve their swimming skills.",
  },
  msc2: {
    Sr: "Kroz prilagođeni program obuke, radim sa uzrastom dece od 5 do 14 godina i odraslima koji su neplivači ili koji žele da unaprede svoje veštine. Moje iskustvo i pristup obuci su posebno prilagođeni svakom pojedincu, sa ciljem da se osnaži samopouzdanje i izgradi sigurnost u vodi.",
    En: "Through a customized training program, I work with children ages 5 to 14 and adults who are non-swimmers or who want to improve their skills. My experience and approach to training is tailored to each individual, with the goal of boosting self-confidence and building safety in the water.",
  },
  bio1: {
    Sr: "U okviru individualnog treninga u plivanju, klijenti dobijaju personalizovani pristup koji je usklađen sa njihovim posebnim izazovima, potrebama i ciljevima u plivanju. Ova personalizovana obuka sadrži detaljna uputstva za svaku vežbu koja klijentima omogućava da poboljšaju svoje veštine i povećaju samopouzdanje u vodi. Ova vrsta obuke omogućava plivačkom treneru da se fokusira na pojedinačne probleme i tehnike poput pravilne tehnike disanja, udaraca nogama, plutanja i drugih tehnika koje su specifične za plivanje u bazenu ili otvorenoj vodi.",
    En: "As part of individual swimming training, clients receive a personalized approach that is aligned with their particular swimming challenges, needs and goals. This personalized training includes step-by-step instructions for each exercise allowing clients to improve their skills and increase their confidence in the water. This type of training allows the swimming coach to focus on individual problems and techniques such as proper breathing technique, kicks, floating and other techniques specific to pool or open water swimming.",
  },
  bio2: {
    Sr: "Individualni programi mogu uključivati ​​i tehnike relaksacije i pripreme tela koje pomažu u povećanju mobilnosti i fleksibilnosti. Cilj je da klijenti rade na svojim veštinama u cilju unapređenja ličnog plivanja.",
